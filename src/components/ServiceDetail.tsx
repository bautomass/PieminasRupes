...
export default function ServiceDetail({ serviceId }: ServiceDetailProps) {
  ...
  const renderRegularService = () => (
    <div className="space-y-10">
      ...
      >
        <motion.h3 variants={itemVariants} className="text-2xl font-bold text-gray-900 dark:text-white mb-4">
        ...
        <motion.h4 variants={itemVariants} className="text-xl font-bold text-gray-900 dark:text-white mb-6">
        ...
        <motion.p variants={itemVariants} className="mt-6 text-gray-700 dark:text-gray-300 italic">
        ...
        >
          ...
          <ul className="space-y-3 bg-gray-50 dark:bg-gray-900/50 p-6 rounded-lg">
            {t.serviceDetails.additionalServices.graveTending.features.map((feature, index) => (
        ...
        >
          ...
          <div className="bg-gray-50 dark:bg-gray-900/50 p-6 rounded-lg">
            <ul className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              {t.serviceDetails.additionalServices.yearlyServices.options.map((option, index) => (
  ...
  const renderSeasonalService = () => (
    <div className="space-y-10">
      ...
      >
        ...
        >
          <h4 className="text-xl font-bold text-gray-900 dark:text-white mb-4">
            {language === "lv" ? "Kapavietas dekorēšana" : 
             language === "en" ? "Grave decoration" : 
             language === "ru" ? "Украшение могилы" : 
             "Grabdekoration"}
          </h4>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="bg-emerald-50 dark:bg-emerald-900/20 p-4 rounded-lg">
              ...
              <ul className="space-y-2">
                {t.serviceDetails.packages.standard.features.map((feature, index) => (
                  <li key={index} className="flex items-start">
            ...
            <div className="bg-emerald-50 dark:bg-emerald-900/20 p-4 rounded-lg border border-emerald-200 dark:border-emerald-800">
              ...
              <ul className="space-y-2">
                {t.serviceDetails.packages.plus.features.map((feature, index) => (
                  <li key={index} className="flex items-start">
                    <CheckIcon className="flex-shrink-0 w-4 h-4 mt-1 text-emerald-600 dark:text-emerald-400" />
                    <span className="ml-2 text-sm text-gray-700 dark:text-gray-300">
                      {feature}
            ...
            <div className="bg-emerald-50 dark:bg-emerald-900/20 p-4 rounded-lg">
              ...
              <ul className="space-y-2">
                {t.serviceDetails.packages.premium.features.map((feature, index) => (
                  <li key={index} className="flex items-start">
                    <CheckIcon className="flex-shrink-0 w-4 h-4 mt-1 text-emerald-600 dark:text-emerald-400" />
                    <span className="ml-2 text-sm text-gray-700 dark:text-gray-300">
                      {feature}
  ...
  const renderRestorationService = () => (
    <div className="space-y-10">
      ...
      >
        ...
        <motion.div variants={itemVariants} className="bg-gray-50 dark:bg-gray-900/50 rounded-lg p-6 mb-8">
          <p className="text-gray-700 dark:text-gray-300">
            {language === "lv" ? (
              <>
                Piedāvājam profesionālu pieminekļu un kapavietu elementu atjaunošanu un tīrīšanu, lai saglabātu to cieņu un skaistumu.
                <br /><br />
                Visi darbi tiek veikti uz vietas, un lielākā daļa projektu var tikt pabeigta vienas dienas laikā.
                <br /><br />
                <strong>Lūdzu ņemiet vērā:</strong> lai gan mēs cenšamies noņemt visus netīrumus un nogulsnes no pieminekļa, daži nolietojumi, traipi un bojājumi var palikt, īpaši ja piemineklis ir ļoti vecs, tas ir slikti uzturēts vai ir izgatavots no īpaši poraina akmens.
              </>
            ) : language === "en" ? (
              <>
                We offer professional restoration and cleaning of monuments and grave elements to maintain their dignity and beauty.
                <br /><br />
                All work is carried out on site, and most projects can be completed in one day.
                <br /><br />
                <strong>Please note:</strong> whilst we make every endeavour to remove all dirt and grime from the headstone, some wear and tear, stains and decay may remain, especially if the memorial is very old, has been poorly maintained or is constructed of a particularly porous stone.
              </>
            ) : language === "ru" ? (
              <>
                Мы предлагаем профессиональную реставрацию и очистку памятников и элементов могилы для поддержания их достоинства и красоты.
                <br /><br />
                Все работы выполняются на месте, и большинство проектов можно завершить за один день.
                <br /><br />
                <strong>Обратите внимание:</strong> несмотря на то, что мы делаем все возможное, чтобы удалить всю грязь с надгробия, некоторые следы износа, пятна и разрушения могут остаться, особенно если памятник очень старый, плохо обслуживался или изготовлен из особо пористого камня.
              </>
            ) : (
              <>
                Wir bieten professionelle Restaurierung und Reinigung von Denkmälern und Grabelementen an, um ihre Würde und Schönheit zu erhalten.
                <br /><br />
                Alle Arbeiten werden vor Ort durchgeführt, und die meisten Projekte können an einem Tag abgeschlossen werden.
                <br /><br />
                <strong>Bitte beachten Sie:</strong> Obwohl wir uns bemühen, allen Schmutz vom Grabstein zu entfernen, können einige Abnutzungen, Flecken und Verfall bestehen bleiben, insbesondere wenn das Denkmal sehr alt ist, schlecht gepflegt wurde oder aus einem besonders porösen Stein besteht.
              </>
            )}
          </p>
        </motion.div>
        ...
        <motion.div variants={itemVariants}>
          ...
          <ul className="space-y-3 bg-gray-50 dark:bg-gray-900/50 rounded-lg p-6">
            {t.serviceDetails.additionalServices.additional.features.map((feature, index) => (
              <li key={index} className="flex items-start">
                <CheckIcon className="flex-shrink-0 w-5 h-5 mt-1 text-emerald-600 dark:text-emerald-400" />
                <span className="ml-3 text-gray-700 dark:text-gray-300">
                  {feature}
  ...
  const renderCustomService = () => (
    <div className="space-y-10">
      ...
      >
        ...
        <motion.div variants={itemVariants} className="bg-emerald-50 dark:bg-emerald-900/20 rounded-lg p-6 border border-emerald-100 dark:border-emerald-800/30 mb-8">
          <h5 className="font-bold text-gray-900 dark:text-white mb-4">
            {language === "lv" ? "Individuālie risinājumi ietver:" : 
              language === "en" ? "Custom solutions include:" :
              language === "ru" ? "Индивидуальные решения включают:" :
          ...
          <ul className="space-y-3">
            <li className="flex items-start">
              <CheckIcon className="flex-shrink-0 w-5 h-5 mt-1 text-emerald-600 dark:text-emerald-400" />
              <span className="ml-3 text-gray-700 dark:text-gray-300">
                {language === "lv" ? "Īpašas pieprasījumus kapu kopšanā" : 
                  language === "en" ? "Special requests in grave care" :
                  language === "ru" ? "Особые запросы по уходу за могилой" :
            ...
            <li className="flex items-start">
              <CheckIcon className="flex-shrink-0 w-5 h-5 mt-1 text-emerald-600 dark:text-emerald-400" />
              <span className="ml-3 text-gray-700 dark:text-gray-300">
                {language === "lv" ? "Konsultācijas par kapu vietas labiekārtošanu" : 
                  language === "en" ? "Consultations on grave site improvement" :
                  language === "ru" ? "Консультации по благоустройству места захоронения" :
            ...
            <li className="flex items-start">
              <CheckIcon className="flex-shrink-0 w-5 h-5 mt-1 text-emerald-600 dark:text-emerald-400" />
              <span className="ml-3 text-gray-700 dark:text-gray-300">
                {language === "lv" ? "Kapavietas meklēšana un situācijas novērtējums" : 
                  language === "en" ? "Grave site location and situation assessment" :
                  language === "ru" ? "Поиск могилы и оценка ситуации" :
            ...
            <li className="flex items-start">
              <CheckIcon className="flex-shrink-0 w-5 h-5 mt-1 text-emerald-600 dark:text-emerald-400" />
              <span className="ml-3 text-gray-700 dark:text-gray-300">
                {language === "lv" ? "Individuāli kopšanas grafiki un risinājumi" : 
                  language === "en" ? "Individual maintenance schedules and solutions" :
                  language === "ru" ? "Индивидуальные графики обслуживания и решения" :
            ...
            <li className="flex items-start">
              <CheckIcon className="flex-shrink-0 w-5 h-5 mt-1 text-emerald-600 dark:text-emerald-400" />
              <span className="ml-3 text-gray-700 dark:text-gray-300">
                {language === "lv" ? "Personalizēts serviss atbilstoši jūsu vēlmēm" : 
                  language === "en" ? "Personalized service according to your wishes" :
                  language === "ru" ? "Персонализированный сервис в соответствии с вашими пожеланиями" :
        ...
        <motion.div variants={itemVariants} className="mt-8 p-6 bg-gray-50 dark:bg-gray-900/50 rounded-lg border border-gray-200 dark:border-gray-700">
          <p className="text-gray-700 dark:text-gray-300">
            {language === "lv" ? (
        ...
        {/* Payment information */}
        <motion.div variants={itemVariants} className="mt-10 border-t border-gray-200 dark:border-gray-700 pt-8">
          <div className="bg-emerald-50 dark:bg-emerald-900/20 p-6 rounded-lg border border-emerald-100 dark:border-emerald-800/30">
            <h4 className="font-bold text-gray-900 dark:text-white mb-3">
              {language === "lv" ? "Informācija par maksājumiem" : 
               language === "en" ? "Payment information" : 
               language === "ru" ? "Информация об оплате" : 
...
//         <motion.div
//           variants={itemVariants}
//           className="bg-emerald-50 dark:bg-emerald-900/20 rounded-lg p-6 border border-emerald-100 dark:border-emerald-800/30"
//         >
//           <h5 className="font-bold text-gray-900 dark:text-white mb-4">
//             {language === "lv"
