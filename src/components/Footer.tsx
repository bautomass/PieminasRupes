...
export default function Footer() {
  ...
  const footerLinks = {
    lv: {
      ...
      contact: "Kontakti",
      pricing: "Cenas",
      faq: "BUJ", // Added FAQ translation for Latvian
    ...
    en: {
      ...
      contact: "Contact",
      pricing: "Pricing",
      faq: "FAQ", // Added FAQ translation for English
    ...
    ru: {
      ...
      contact: "Контакты",
      pricing: "Цены",
      faq: "ЧЗВ", // Added FAQ translation for Russian
    ...
    de: {
      ...
      contact: "Kontakt",
      pricing: "Preise",
      faq: "FAQ", // Added FAQ translation for German
