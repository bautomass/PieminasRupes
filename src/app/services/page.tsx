...
export default function ServicesPage() {
  ...
  // Define one-time prices based on your pricing page - adjust these values to match your pricing page
  const oneTimePrices = {
    Maza: 40, // Small
    Small: 40,
    Маленькая: 40,
  ...
  return (
    <div className="bg-gray-50 dark:bg-gray-900">
      ...
      <section className="py-10 bg-white dark:bg-gray-800 md:py-12 lg:py-14">
              ...
              >
                <div className="p-6">
                  ...
                  <ul className="space-y-2 mb-8">
                    {service.features.map((feature, featureIndex) => (
                      <li key={featureIndex} className="flex items-start">
                        <CheckIcon className="flex-shrink-0 w-5 h-5 mt-0.5 text-emerald-500 dark:text-emerald-400" />
                  ...
                  <div className="relative pb-10 mt-6">
                    ...
                    {activeService !== service.id ? (
                      <div className="absolute -bottom-4 left-1/2 transform -translate-x-1/2 opacity-0 group-hover:opacity-100 transition-all duration-300 pointer-events-none flex items-center justify-center w-full">
                      ...
                      <div className="absolute -bottom-6 left-1/2 transform -translate-x-1/2 opacity-0 group-hover:opacity-100 transition-all duration-300 pointer-events-none flex items-center justify-center w-full">
                        <div className="bg-emerald-100 dark:bg-emerald-800/60 rounded-full p-2 shadow-md dark:shadow-emerald-900/30">
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                            className="h-6 w-6 text-emerald-600 dark:text-emerald-400 animate-pulse"
            ...
            <div className="flex space-x-4 w-max snap-x snap-mandatory">
              {services.map((service, index) => (
                <motion.div
                  ...
                  animate={{ opacity: 1, y: 0 }}
                  transition={{ duration: 0.4, delay: index * 0.1 }}
                  className={`flex-shrink-0 w-[calc(83.333vw)] snap-center bg-white dark:bg-gray-800 border rounded-xl shadow-md dark:shadow-emerald-900/10 overflow-hidden hover:shadow-lg dark:hover:shadow-emerald-800/20 transition-all duration-300 group ${
                    activeService === service.id
                      ? "ring-2 ring-emerald-500 dark:ring-emerald-400"
                      : "border-gray-200 dark:border-gray-700"
                  }`}
                >
                  <div className="p-6">
                    ...
                    <div className="relative pb-10 mt-6">
                      ...
                      {/* Improved arrow indicators - mobile version */}
                      {activeService !== service.id ? (
                        <div className="absolute -bottom-6 left-1/2 transform -translate-x-1/2 opacity-0 group-hover:opacity-100 transition-all duration-300 pointer-events-none flex items-center justify-center w-full">
                          <div className="bg-emerald-100 dark:bg-emerald-800/60 rounded-full p-2 shadow-md dark:shadow-emerald-900/30">
                            <svg
      ...
      <section className="py-16 dark:bg-gray-900 border-t border-gray-200 dark:border-gray-700">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="text-center mb-10">
            ...
            <div className="mx-auto w-24 h-px bg-gradient-to-r from-emerald-300 via-emerald-600 to-emerald-300 dark:from-emerald-700 dark:via-emerald-500 dark:to-emerald-700 mb-6"></div>
          ...
          <div className="bg-emerald-50 dark:bg-emerald-900/20 p-8 rounded-lg border border-emerald-200 dark:border-emerald-800/50">
            <div className="flex flex-col md:flex-row items-start md:items-center">
              <div className="flex-shrink-0 bg-emerald-100 dark:bg-emerald-800 p-3 rounded-full mr-4 mb-4 md:mb-0">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              {/* Pricing type toggle */}
              <div className="mt-6 inline-flex p-1 bg-gray-100 dark:bg-gray-700 rounded-lg">
                <button
                ...
                >
                  ...
                  <div className="p-6 text-center">
                    ...
                    <div className="text-3xl font-bold text-emerald-600 dark:text-emerald-400 bg-emerald-50 dark:bg-emerald-900/20 px-6 py-4 rounded-lg border border-emerald-100 dark:border-emerald-800/20 mx-auto inline-block shadow-sm">
                      {showSubscription
                        ? `${size.price}€`
                        : `${oneTimePrices[size.title as keyof typeof oneTimePrices] || (parseInt(size.price) * 1.2).toFixed(0)}€`}
                    </div>
              ...
              <div className="flex space-x-4 w-max snap-x snap-mandatory">
                {pricingSizes.map((size, index) => (
                  <motion.div
                    ...
                    animate={{ opacity: 1, y: 0 }}
                    transition={{ duration: 0.5, delay: index * 0.1 }}
                    className="flex-shrink-0 w-[calc(83.333vw)] snap-center bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 shadow-lg dark:shadow-emerald-900/10 overflow-hidden"
                  >
                    <div className="bg-gradient-to-b from-emerald-50 to-white dark:from-emerald-900/20 dark:to-gray-800 border-b border-gray-100 dark:border-gray-700 p-4">
                      <h3 className="text-xl font-bold text-center text-gray-900 dark:text-white">
                        {size.title}
            ...
            <div className="md:hidden flex justify-center mt-6 space-x-3">
              {pricingSizes.map((_, i) => (
                <button
                  ...
                  aria-label={`Go to pricing option ${i + 1}`}
                />
              ))}
            </div>
            ...
            <div className="mt-10 text-center">
              <div className="bg-amber-50 dark:bg-amber-900/20 border-2 border-amber-400 dark:border-amber-700 p-5 rounded-lg shadow-lg max-w-2xl mx-auto relative overflow-hidden">
                <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-amber-400 to-amber-300 dark:from-amber-700 dark:to-amber-600"></div>
