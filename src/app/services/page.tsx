...
export default function ServicesPage() {
  ...
  return (
    <div className="bg-gray-50 dark:bg-gray-900">
      ...
      {/* Highly Improved Service Coverage Area Section */}
      <section className="py-16 bg-gradient-to-b from-emerald-600 to-emerald-700 dark:from-emerald-700 dark:to-emerald-800">
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto">
            <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 md:p-12 shadow-2xl border border-white/20">
              <div className="text-center mb-10">
                <div className="inline-block bg-white/20 text-white font-medium px-5 py-2 rounded-full tracking-wider mb-4 backdrop-blur-sm">
                  <span className="mix-blend-overlay">✦</span>{" "}
                  {language === "lv" ? "REĢIONI" : "REGIONS"}{" "}
                  <span className="mix-blend-overlay">✦</span>
                </div>
                <h2 className="text-3xl md:text-4xl font-serif font-bold text-white mb-4 drop-shadow-md">
                  {language === "lv"
                    ? "Savus pakalpojumus sniedzam:"
                    : t.memorial.serviceArea}
                </h2>
                <div className="mx-auto w-32 h-[2px] bg-white/40 mb-6"></div>
                <p className="text-white/80 text-lg max-w-2xl mx-auto">
                  {language === "lv"
                    ? "Mūsu komanda nodrošina profesionālus kapu kopšanas pakalpojumus šajos reģionos:"
                    : "Our team provides professional grave care services in these regions:"}
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-10">
                {t.memorial.serviceAreas.map((area, index) => (
                  <div key={index} className="relative group">
                    <div className="absolute inset-0 bg-gradient-to-br from-emerald-300/20 to-white/30 rounded-lg blur-xl opacity-70 group-hover:opacity-100 transition-opacity duration-300"></div>
                    <div className="relative bg-white/15 backdrop-blur-md px-8 py-6 rounded-lg shadow-lg hover:shadow-xl border border-white/20 transition-all duration-300 transform group-hover:-translate-y-1 h-full flex items-center justify-center">
              ...
              <div className="flex justify-center mt-8">
                <Link
                  href="/contact"
                  className="group inline-flex items-center px-10 py-5 text-base font-medium bg-white text-emerald-700 rounded-lg transition-all duration-300 shadow-xl hover:shadow-2xl transform hover:-translate-y-1 focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-emerald-600"
                >
                  <span className="tracking-wide">{t.memorial.ctaButton}</span>
                  <svg
              ...
              >
                <div className="p-6">
                  ...
                  <div className="relative pb-10 mt-6">
                    ...
                    {activeService !== service.id ? (
                      <div className="absolute bottom-0 left-1/2 transform -translate-x-1/2 text-emerald-600 dark:text-emerald-400 opacity-80 transition-all duration-300 animate-bounce pointer-events-none">
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          className="h-6 w-6"
                          fill="none"
