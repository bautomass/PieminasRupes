...
const FAQAccordion = memo(
  ({ questions, activeTab, setActiveTab }: FAQAccordionProps) => {
        ...
        {questions.map((faq, index: number) => (
          ...
          >
            <button
              ...
              className="flex items-start justify-between w-full text-left focus:outline-none focus-visible:ring-2 focus-visible:ring-emerald-500 focus-visible:ring-offset-2 rounded-md"
...
const CategoryTabs = memo(
  ({ categories, activeCategory, setActiveCategory }: CategoryTabsProps) => {
    return (
      <div className="relative">
        ...
        <div
          className="md:hidden absolute right-0 top-0 bottom-0 w-12 bg-gradient-to-l from-white dark:from-gray-800 to-transparent pointer-events-none"
          aria-hidden="true"
        ></div>
        <div
          className="md:hidden absolute left-0 top-0 bottom-0 w-12 bg-gradient-to-r from-white dark:from-gray-800 to-transparent pointer-events-none"
          aria-hidden="true"
        ></div>
      </div>
    );
...
// Create a RelatedLinks component
const RelatedLinks = memo(({ translate }: { translate: TranslateFunction }) => (
  <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
    <Link
      href="/services"
      className="group p-6 dark:bg-gray-850 border border-gray-200 dark:border-gray-700 rounded-lg transition-all duration-300 hover:shadow-md hover:border-emerald-200 dark:hover:border-emerald-800 focus:outline-none focus-visible:ring-2 focus-visible:ring-emerald-500 focus-visible:ring-offset-2"
    >
    ...
    <div className="max-w-4xl mx-auto bg-white dark:bg-gray-800 rounded-lg shadow-lg overflow-hidden">
      <div className="p-8 md:p-12">
        ...
        <div className="flex flex-wrap justify-center gap-6">
          <Link
            href="/contact"
            className="inline-flex items-center px-6 py-3 bg-emerald-600 text-white rounded-md hover:bg-emerald-700 transition-colors duration-300 focus:outline-none focus-visible:ring-2 focus-visible:ring-emerald-500 focus-visible:ring-offset-2"
          ...
          <a
            ...
            className="inline-flex items-center px-6 py-3 bg-gray-100 text-gray-700 rounded-md hover:bg-gray-200 dark:bg-gray-700 dark:text-gray-300 dark:hover:bg-gray-600 transition-colors duration-300 focus:outline-none focus-visible:ring-2 focus-visible:ring-gray-500 focus-visible:ring-offset-2"
            aria-label={translate(
              "Zvanīt mums",
              "Call Us",
              "Позвоните нам",
...
export default function FAQPage(): React.ReactElement {
  ...
  const currentFAQs = useMemo(() => {
    ...
    return selectedCategory?.questions || categories[0].questions;
  ...
  const pageTitle = useMemo(
    () =>
      translate(
        "Biežāk uzdotie jautājumi | SkyGarden - Kapu kopšanas serviss",
        "Frequently Asked Questions | SkyGarden - Grave Care Service",
        "Часто задаваемые вопросы | SkyGarden - Услуги по уходу за могилами",
        "Häufig gestellte Fragen | SkyGarden - Grabpflegedienst"
      ),
    [translate]
  );
  ...
  const pageDescription = useMemo(
    () =>
      translate(
        "Atbildes uz biežāk uzdotajiem jautājumiem par mūsu kapu kopšanas pakalpojumiem, cenām un pasūtīšanas procesu.",
        "Answers to frequently asked questions about our grave care services, pricing, and ordering process.",
        "Ответы на часто задаваемые вопросы о наших услугах по уходу за могилами, ценах и процессе заказа.",
        "Antworten auf häufig gestellte Fragen zu unseren Grabpflegediensten, Preisen und Bestellprozessen."
      ),
    [translate]
  );
  ...
  const handleCategoryChange = useCallback((category: string) => {
    ...
    setActiveTab(-1); // Reset active tab when changing categories
  }, []);
  ...
  return (
    <>
      ...
      <div className="bg-gray-50 dark:bg-gray-900">
        ...
        {/* Hero Section */}
        <section
          className="py-16 bg-white dark:bg-gray-800 md:py-20 lg:py-24"
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-5xl mx-auto">
              <div className="text-center mb-12">
                ...
                <div
                  className="mt-4 mx-auto w-16 h-[2px] bg-gradient-to-r from-emerald-300 via-emerald-600 to-emerald-300 dark:from-emerald-700 dark:via-emerald-500 dark:to-emerald-700"
                  aria-hidden="true"
                ></div>
              </div>

              <RelatedLinks translate={translate} />
            </div>
          </div>
        </section>
