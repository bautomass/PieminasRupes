...
//   // Generate plans dynamically from pricing sizes
//   const plans = pricingSizes.map((size) => {
//     const priceString = size.price.split(" "); // Splits "25 EUR mēnesī" into parts
//     const price = priceString[0]; // "25"

//     // Calculate yearly price (10% discount)
//     const yearlyPrice = Math.round(parseInt(price) * 12 * 0.9).toString();
...
//       size: size.size,
//       price: price,
//       interval: t.serviceDetails.pricing.monthly || "monthly",
